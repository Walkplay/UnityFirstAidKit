...
namespace PackageHandler.DecompressModule
{
	...
	public class TarGzArchivator 
	{
        ...
        public void Decompress(FileInfo fileToDecompress, string destinationPath)
        {
            ExtractTarGz(fileToDecompress.FullName, destinationPath);
        }
